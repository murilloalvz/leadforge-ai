...
from app.services.discovery.geoapify_relevance import RelevantGeoapifyProvider
...
def _geoapify_provider() -> RelevantGeoapifyProvider:
    settings = get_settings()
    return RelevantGeoapifyProvider(
